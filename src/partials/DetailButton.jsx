...
const DetailButton = ({ immobile }) => {
  return (
    <StyledWrapper>
      <a className="button w-25 text-wine" href={`mailto:${immobile?.proprietario_email}?subject=Richiesta informazioni su ${immobile?.descrizione_immobile}`}>
        <div className="outline" />
        <div className="state state--default pt-3">
          <div className="icon">
        ...
        <div className="state state--sent pt-3">
          <div className="icon">
...
text-decoration: none;}
  .button {
    ...
    box-shadow: 0 0.5px 0.5px 1px rgba(255, 255, 255, 0.2),
      0 5px 5px rgba(0, 0, 0, 0.2), 0 4px 5px 0px rgba(0, 0, 0, 0.05);
    display: flex;
    align-items: center;
  ...
  .button:hover {
    ...
    box-shadow: 0 0 1px 2px rgba(255, 255, 255, 0.3),
      0 10px 20px rgba(0, 0, 0, 0.3), 0 10px 3px -3px rgba(0, 0, 0, 0.04);
  }
  .button:active {
    transform: scale(1);
    box-shadow: 0 0 1px 2px rgba(255, 255, 255, 0.3),
